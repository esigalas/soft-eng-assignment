...
**Description**: Το σύστημα θα πρέπει να είναι διαθέσιμο για να το χρησιμοποιείσει ο χρήστης περισσότερες απο 98 στις 100 φορές.
...
**Description**: Η εφαρμογή αναφέρεται σε άτομα όλων των ηλικιών για αυτό το λόγο θα πρέπει να είναι εύκολα κατανοητή απο όλους.
