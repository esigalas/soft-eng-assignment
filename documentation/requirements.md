...
#### User story
[Kart feature/story](https://github.com/esigalas/soft-eng-assignment/blob/master/requirements/Kart.feature)
...
**Description**: Κάθε χρήστης αφού έχει προσθέσει προϊόντα στο καλάθι της παραγγελίας του θα μπορεί να ολοκληρώσει την παραγγελία του και θα του εμφανίζεται ένα μήνυμα επιτυχίας ή αποτυχίας.
