...
**Technical difficulty**(4/5): Αυτή η μη λειτουργική απαίτηση είναι αρκέτα δύσκολη γιατί πρέπει να προστεθούν κάποιες έξτρα δυνατότητες στο σάιτ.
...
**Technical difficulty**(2/5): Αυτή η μη λειτουργική απαίτηση δεν είναι ιδιάιτερα δύσκολη στην υλοποίηση καθώς απλά θα γίνεται ένας συσχετισμός
