...
**User Priority**(5/5): Αυτή η λειτουργία είναι πολύ σημαντική για τον χρήστη γιατί θα θέλει να μπορεί να λειτουργεί το σύστημα στον browser της επιλογής του χωρίς προβλήματα.
