...
**Description**: Κάθε χρήστης θα έχει την δυνατότητα να συνδεθεί στο σύστημα όταν και όποτε επιθυμεί. Έπειτα θα μπορεί να προχωρήσει στην δημιουργία της παραγγελίας του καθώς ο λογαριασμός θα περιέχει όλες τις απαραίτητες πληροφορίες που χρειάζεται το σύστημα για να ολοκληρώσει μια παραγγελία, όπως η διεύθυνση, το όνομα και το τηλέφωνο του χρήστη.
...
**Technical difficulty** (2/5): Η λειτουργική αυτή απαίτηση δεν είναι ιδιαίτερα απαιτητική αφού είναι πιθανή η αυτόματη σύνδεση του με το σύστημα αν το επιλέξει ο ίδιος ο χρήστης. 


### ΛΑ-2
Ο χρήστης πρέπει να μπορεί να κάνει έξοδο απο την υπηρεσία (Logout).

**Description**: Κάθε χρήστης που έχει συνδεθεί θα έχει την δυνατότητα να αποσυνδεθεί από το σύστημα όταν και όποτε επιθυμεί. Μόλις αποσυνδεθεί θα έχει δικαιώματα απλού επισκέπτη και δεν θα μπορεί να ολοκληρώσει μια παραγγελία.
...
**Description**: Κάθε χρήστης για να μπορεί να συνδεθεί στο σύστημα και να ολοκλήρώσει κάποια παραγγελία του θα πρέπει πρώτα να εγγραφεί στο σύστημα. Με αυτόν τον τρόπο θα δημιουργεί έναν λογαριασμό με όλα τα απαραίτητα στοιχεία του. Τα στοιχεία που θα πρέπει να συμπληρώσει είναι το όνομα, η διεύθυνση και το τηλέφωνο του.

**User Priority**(5/5): Για τον χρήστη αυτή η λειτουργία είναι πολύ σημαντική γιατί αν δεν διεκπαιρεωθεί ο χρήστης δεν θα μπορεί να χρησιμοποιήσει το σύστημα.
...
**Description**: Κάθε χρήστης θα έχει την δυνατότητα να επιλέξει την γλώσσα που επιθυμεί ανάμεσα σε αγγλικά και ελληνικά.

**User Priority**(4/5): Για τον χρήστη αυτή η λειτουργία είναι αρκετά σημαντική διότι του δίνει την δυνατότητα να επιλέξει τον τρόπο επικοινωνίας που τον βολεύει καλύτερα. 
...
**Description**: Κάθε χρήστης θα έχει την δυνατότητα να επιλέξει τον τρόπο με τον οποίο θέλει να πληρώσει, είτε με μετρητά κατά την παράδοση της παραγγελίας είτε με κάρτα ηλεκτρονικά.

**User Priority**(4/5): Για τον χρήστη αυτή η λειτουργία είναι αρκετά σημαντική διότι του δίνει την ελευθερία να επιλέξει τον τρόπο πληρωμής που τον βολεύει περισσότερο. 
...
**Description**: Κάθε χρήστης θα έχει την δυνατότητα, μέσω μιας μηχανής αναζήτησης, να αναζητά ένα συγκεκριμένο κατάστημα της επιλογής του, το οποίο γνωρίζει εκ των προτέρων και βρίσκεται ψηλά στις προτιμήσεις του. Σκοπός αυτής της λειτουργίας είναι λοιπόν να μπορεί να βρίσκει γρήγορα και εύκολα αυτά τα καταστήματα.
...
**Description**: Κάθε χρήστης επιλέγοντας κάποιο κατάστημα θα μπορεί να βλέπει σε μορφή λίστας τα διάφορα προϊόντα που διαθέτει αυτό το κατάστημα καθώς και τις τιμές τους.
...
**Description**: Κάθε χρήστης θα έχει τη δυνατότητα να βλέπει το πως έχουν αξιολογήσει άλλοι χρήστες κάποιο κατάστημα, καθώς και διάφορα σχόλια αυτών των χρηστών για το κατάστημα.
...
**Description**: Κάθε χρήστης θα έχει τη δυνατότητα να αξιολογεί τα καταστήματα από τα οποία έχει παραγγείλει επιλέγοντας μια βαθμολογία με αστέρια από το 1-5. Επίσης θα μπορεί να αφήνει κάποιο σχόλιο για τις εντυπώσεις του από το φαγητό και την εξυπηρέτηση που είχε.
...
**Description**: Στην αρχική σελίδα κάθε χρήστη θα υπάρχει στα δεξιά της οθόνης του η λίστα με όλα τα καταστήματα εκείνα που έχει προσθέσει στα αγαπημένα του για να μπορεί να τα βρίσκει γρήγορα.

**User Priority**(5/5): Αυτή η λειτουργία είναι πολύ σημαντική για τον χρήστη για τους ίδιους λόγους που ισχύουν και για την προηγούμενη ΛΑ.

**Technical difficulty**:

### ΛΑ-18
Το σύστημα πρέπει να  απεικονίζει μια λίστα με τις τελευταίες παραγγελίες του χρήστη.

**Description**: Κάθε χρήστης θα έχει τη δυνατότητα να βλέπει στην αρχική σελίδα τις 5 προηγούμενες παραγγελίες του και να βλέπει ποιες ήταν οι προτιμήσεις του.
...
**Description**: Την στιγμή που ο χρήστης θα επιλέξει κάποιο κατάστημα για να κάνει μία παραγγελία θα εμφανίζεται στα δεξιά της σελίδας ένα καλάθι σε μορφή λίστας που θα περιέχει τα προϊόντα που θα επιλέγει ο χρήστης να παραγγείλει. Στο καλάθι επίσης θα εμφανίζεται και το άθροισμα των τιμών των προϊόντων που έχει προσθέσει ο χρήστης.

**User Priority**(5/5): Αυτή η λειτουργία είναι πολύ σημαντική για τον χρήστη γιατί θα μπορεί να βλέπει συγκεντρωμένα τα προϊόντα που έχει επιλέξει καθώς και το συνολικό κόστος τους.
...
**Description**: Κάθε χρήστης θα μπορεί να αφαιρεί κάποιον προϊόν που έχει προσθέσει στο καλάθι της παραγγελίας του. 
...
**Description**: Κάθε χρήστης αφού έχει προσθέσει προϊόντα στο καλάθι της παραγγελίας του θα μπορεί πατώντας ένα κουμπί να ολοκληρώσει την παραγγελία του.
...
**Description**: Το σύστημα θα πρέπει να είναι συμβατό με όλους τους δημοφιλής browsers, όπως είναι ο Ιnternet Εxplorer, o Μozilla Firefox, o Google Chrome, o Safari και ο Opera. 

**User Priority**(5/5): Αυτή η λειτουργία είναι πολύ σημαντική για τον χρήστη γιατί θα θέλει να μπορεί να λειτουργεί το σύστημα στον browser τηε επιλογής του χωρίς προβλήματα.
...
**Description**: Όταν κάποιος χρήστης θα επιλέγει κάποια εντολή του συστήματος το σύστημα θα πρέπει να την ολοκληρώνει σε χρόνο μικρότερο τοων τριών δευτερολέπτων.
...
**Description**: Ανάλογα τις προτιμήσεις του χρήστη, θα μπορεί να ταξινόμεί τα καταστήματα είτε με βάση το κόστος ελάχιστης παραγγελίας, είτε με τον ελάχιστον χρόνο που θέλει ένα κατάσταμα να παραδώσει την παραγγελία, είτε με την απόσταση του τόπου παράδοσης από το κατάστημα είτε από το εαν έχει ψηλές ή χαμηλές αξιολογήσεις. 
...
**Description**: Θέλουμε το σύστημα να παρουσιάζει ακριβώς αυτό που φιλτράρει ο χρήστης, δηλαδή όταν θα επιθυμεί να δει πχ τις πιτσαρίες να έχει γίνει σωστά η κατηγοριοποίησει των καταστημάτων και να μην παρουσιαστούν άλλου τύπου καταστήματα σε αυτό το φίλτρο.

**User Priority**(4/5): Είναι αρκετά σημαντικό για τον χρήστη να παίρνει αξιόπιστα αποτελέσματα από το φιλτράρισμα που επιλέγει έτσι ώστε να συνεχίσει να προτιμά το σύστημα μας.
